...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the DennyDesk network..."),
        ...
        ("Slogan_tip", "Made with love and nearly hunger level hourly salary."),
        ...
        ("config_acc", "In order to control your Desktop remotely, you need to grant DennyDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant DennyDesk \"Screen Recording\" permissions."),
        ...
        ("setup_server_tip", " ITS Service Desk 740-587-6395 & servicedesk@denison.edu"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant DennyDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant DennyDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running DennyDesk."),
